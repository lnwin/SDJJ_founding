...
//===================================================================
   ...
   // QObject *QmlObj=view;//获取QMl的源对象
    ...
    camera_0.setGeometry(QmlWindow->width()*0.65,QmlWindow->height()*0.04,QmlWindow->width()/2*0.68,QmlWindow->height()/2*0.65);//设置widget的大小
    ...
    camera_1.setGeometry(QmlWindow->width()*0.65,QmlWindow->height()*0.06+QmlWindow->height()/2*0.65,QmlWindow->width()/2*0.68,QmlWindow->height()/2*0.65);//设置widget的大小
