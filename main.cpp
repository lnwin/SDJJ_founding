...
//    engine.load(url);
 ...
 //   QQmlApplicationEngine engine;
    ...
    camera_0.setGeometry(QmlWindow->width()*0.012,QmlWindow->height()*0.02,QmlWindow->width()/2*0.5,QmlWindow->height()/2*0.65);//设置widget的大小
    ...
    camera_1.setGeometry(QmlWindow->width()*0.012,QmlWindow->height()*0.025+QmlWindow->height()/2*0.65,QmlWindow->width()/2*0.5,QmlWindow->height()/2*0.65);//设置widget的大小
