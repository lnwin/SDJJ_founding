...
//===================================================================
   ...
   // QObject *QmlObj=view;//获取QMl的源对象
    ...
    camera_0.setGeometry(QmlWindow->width()*0.7,QmlWindow->height()*0.04,QmlWindow->width()/2*0.57,QmlWindow->height()/2*0.65);//设置widget的大小
    ...
    camera_1.setGeometry(QmlWindow->width()*0.7,QmlWindow->height()*0.05+QmlWindow->height()/2*0.65,QmlWindow->width()/2*0.57,QmlWindow->height()/2*0.65);//设置widget的大小
